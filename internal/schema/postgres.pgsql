...
CREATE TABLE gtfs_stop_times_unpartitioned (
    id bigint NOT NULL,
    arrival_time integer NOT NULL,
    departure_time integer NOT NULL,
    stop_sequence integer NOT NULL,
...
CREATE SEQUENCE gtfs_stop_times_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE gtfs_stop_times_id_seq OWNED BY gtfs_stop_times_unpartitioned.id;
...
ALTER TABLE ONLY gtfs_stop_times_unpartitioned ALTER COLUMN id SET DEFAULT nextval('gtfs_stop_times_id_seq'::regclass);
...
ALTER TABLE ONLY gtfs_stop_times_unpartitioned
...
CREATE INDEX index_gtfs_stop_times_on_feed_version_id_trip_id_stop_id ON gtfs_stop_times_unpartitioned USING btree (feed_version_id, trip_id, stop_id);
CREATE INDEX index_gtfs_stop_times_on_stop_id ON gtfs_stop_times_unpartitioned USING btree (stop_id);
CREATE INDEX index_gtfs_stop_times_on_trip_id ON gtfs_stop_times_unpartitioned USING btree (trip_id);
CREATE UNIQUE INDEX index_gtfs_stop_times_unique ON gtfs_stop_times_unpartitioned USING btree (feed_version_id, trip_id, stop_sequence);
...
CREATE UNIQUE INDEX tl_route_headways_route_dow_category_id_idx ON tl_route_headways USING btree (route_id, dow_category);
